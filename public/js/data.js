...
const templates = {
    ...
    bosses: {
        'black_knight_chief': _mob('흑기사 대장', 27000, 455, 100, 5000, [2000, 5000], 30, '#1a1a24', {matk: 455, isBoss: true, desc: '은기사 마을 외곽을 위협하는 초보존 이벤트 보스'}),
        'giant_ungoliant': _mob('거대 웅골리언트', 22500, 455, 90, 4000, [1500, 4000], 40, '#7f1d1d', {matk: 390, isBoss: true, desc: '말하는 섬 생태계의 파괴자 (초보존 보스)'}),
        'corrupted_ent': _mob('타락한 엔트', 31500, 520, 80, 4500, [1000, 3000], 45, '#15803d', {matk: 585, isBoss: true, desc: '요정의 숲 오염의 근원 (초보존 보스)'}),
        'ant_queen': _mob('여왕 개미', 40500, 650, 90, 120000, [10000, 25000], 60, '#78350f', {matk: 585, isBoss: true, drops: [{name: '거대 개미 여왕의 금빛 날개', chance: 0.05}]}),

        'baphomet': _mob('바포메트', 126000, 1040, 110, 150000, [5000, 15000], 30, '#7f1d1d', {matk: 1170, isBoss: true, isUndead: true, isMagicBoss: true, drops: [{name: '바포메트의 지팡이', chance: 0.03}, {name: '마법서 (이럽션)', chance: 0.10}, {name: '무기 마법 주문서', chance: 0.3}, {name: '갑옷 마법 주문서', chance: 0.5}]}),
        'deathknight': _mob('데스나이트', 126000, 1105, 120, 180000, [20000, 50000], 30, '#f87171', {matk: 1235, isBoss: true, isUndead: true, drops: [{name: '데스나이트의 불검', chance: 0.02}, {name: '데스나이트의 갑옷', chance: 0.03}, {name: '기술서 (카운터 바리어)', chance: 0.05}]}),
        'black_elder': _mob('흑장로', 117000, 975, 90, 350000, [50000, 120000], 28, '#0f172a', {matk: 1300, isBoss: true, isMagicBoss: true, drops: [{name: '흑장로의 지팡이', chance: 0.04}, {name: '흑장로의 로브', chance: 0.05}]}),

        'kurz': _mob('커츠', 315000, 1560, 110, 700000, [80000, 250000], 30, '#1e1b4b', {matk: 1560, isBoss: true, drops: [{name: '커츠의 검', chance: 0.03}]}),
        'drake': _mob('드레이크', 342000, 1690, 130, 600000, [80000, 200000], 45, '#1d4ed8', {matk: 1430, isBoss: true}),
        'antharas': _mob('안타라스(지룡)', 378000, 1950, 100, 900000, [100000, 250000], 80, '#166534', {matk: 1820, isBoss: true, drops: [{name: '안타라스의 예지', chance: 0.01}]}),
        'valakas': _mob('발라카스(화룡)', 405000, 2080, 120, 1200000, [200000, 400000], 100, '#dc2626', {matk: 2080, isBoss: true, drops: [{name: '발라카스의 완력', chance: 0.01}]}),
        'zenith_queen': _mob('제니스 퀸', 315000, 1430, 130, 900000, [100000, 250000], 40, '#701a75', {matk: 1560, isBoss: true, isMagicBoss: true}),

        'lich_boss': _mob('리치(보스)', 720000, 1950, 110, 1500000, [200000, 500000], 35, '#312e81', {matk: 2340, isBoss: true, isUndead: true, isMagicBoss: true, drops: [{name: '리치의 로브', chance: 0.03}]}),
        'grim_reaper': _mob('그림 리퍼', 765000, 2210, 140, 700000, [50000, 150000], 60, '#000', {matk: 2600, isBoss: true, isMagicBoss: true, drops: [{name: '그림 리퍼의 투구', chance: 0.02}]}),
        'great_minotaur': _mob('대미노타우르스', 720000, 1820, 100, 1200000, [300000, 800000], 50, '#451a03', {matk: 1430, isBoss: true}),

        'dantes': _mob('명황 단테스', 1350000, 2860, 130, 5000000, [1000000, 2500000], 35, '#0f172a', {matk: 3120, isBoss: true}),
        'awakened_reaper': _mob('각성한 사신', 1620000, 3380, 150, 15000000, [3000000, 8000000], 70, '#581c87', {matk: 3640, isBoss: true, isMagicBoss: true, drops: [{name: '사신의 검', chance: 0.01}]}),
        
        'demon': _mob('데몬', 315000, 1560, 120, 500000, [50000, 150000], 50, '#f22', {matk: 1820, isBoss: true, isMagicBoss: true}),
        'great_spirit': _mob('대정령', 288000, 1430, 100, 300000, [40000, 100000], 40, '#8ff', {matk: 1690, isBoss: true, isMagicBoss: true})
    }
};
...
const itemDb = [
    ...
    _wp("얼음 여왕의 지팡이", 18, 4, { sp: 3, int: 2, skill: '블리자드', desc: '타격 시 확률로 블리자드 발동' }),
    ...
    _wp("제로스의 지팡이", 18, 4, { sp: 5, int: 3, skill: '디스인티그레이트', desc: '궁극의 마법 지팡이' }),
    _wp("살천의 활", 16, 3, { isBow: true, dex: 2, skill: '트리플 애로우' }),
    ...
    _am("오우거의 벨트", "belt", 1, 3, {hpBonus: 50, str: 1, desc: '강력한 힘이 깃든 벨트'}),
...
const magicDb = {
    '에너지 볼트': { mp: 1, range: 300, dmg: 15, type: 'attack', projSpeed: 300, homing: true, icon: '⚡', cd: 800, desc: '[단일 공격] 기초적인 마법 에너지를 발사합니다.' }, 
    '실드': { mp: 8, type: 'buff', icon: '🛡️', cd: 2000, buffType: 'def', val: 2, duration: 300000, desc: '[보조] 방어력(AC)을 -2만큼 낮춰줍니다.' },
    '힐': { mp: 1, heal: 40, type: 'buff', icon: '💚', cd: 1000, desc: '[회복] 소량의 체력을 회복합니다.' }, 
    '가속': { mp: 5, duration: 300000, type: 'buff', icon: '💨', cd: 2000, buffType: 'speed', val: 60, desc: '[보조] 5분간 이동 및 공격 속도가 증가합니다.' }, 
    '파이어볼': { mp: 3, range: 300, dmg: 50, type: 'attack', projSpeed: 650, homing: false, icon: '🔥', aoe: 150, cd: 1500, desc: '[광역 공격] 화염구를 발사하여 반경 150 내의 적들을 공격합니다.' }, 
    '콜 라이트닝': { mp: 2, range: 350, dmg: 35, type: 'attack', icon: '🌩️', cd: 1000, desc: '[단일 공격] 번개를 떨어뜨려 공격합니다.' }, 
    '그레이트 힐': { mp: 5, heal: 150, type: 'buff', icon: '💖', cd: 1500, desc: '[회복] 다량의 체력을 회복합니다.' },
    '이럽션': { mp: 3, range: 250, dmg: 45, type: 'attack', icon: '🌋', cd: 1500, desc: '[단일 공격] 땅에서 용암을 분출시켜 공격합니다.' },
    '뱀파이어릭 터치': { mp: 12, range: 300, dmg: 40, type: 'attack', icon: '🦇', cd: 2000, vampiric: true, desc: '[단일 공격/흡혈] 적에게 데미지를 주고 절반을 HP로 흡수합니다.' },
    '커스 파라다이스': { mp: 15, range: 300, dmg: 10, type: 'attack', icon: '🌀', cd: 2000, desc: '[디버프] 대상의 이동을 방해합니다.' },
    '홀리 워크': { mp: 15, type: 'buff', icon: '✨', cd: 2000, buffType: 'speed', val: 80, duration: 60000, desc: '[보조] 1분간 이동 속도를 비약적으로 상승시킵니다.' },
    '라이트닝 스톰': { mp: 10, range: 350, dmg: 80, aoe: 250, type: 'attack', icon: '⛈️', cd: 2500, desc: '[광역 공격] 넓은 범위에 강력한 번개 폭풍을 일으킵니다.' }, 
    '선버스트': { mp: 20, range: 350, dmg: 110, aoe: 200, type: 'attack', icon: '☀️', cd: 2500, desc: '[광역 공격] 빛의 에너지를 폭발시킵니다.' },
    '어드밴스 스피릿': { mp: 20, type: 'buff', icon: '💫', cd: 3000, buffType: 'maxHpMp', val: 50, duration: 300000, desc: '[보조] 최대 HP와 MP를 50 증가시킵니다.' },
    '서먼 몬스터': { mp: 20, type: 'summon', icon: '🐺', cd: 5000, desc: '[소환] 플레이어의 레벨에 맞는 몬스터를 소환합니다.' },
    '캔슬레이션': { mp: 20, range: 400, type: 'attack', dmg: 1, icon: '🚫', cd: 3000, desc: '[상태 이상] 대상의 모든 이로운 마법을 해제합니다.' },
    '아이스 스파이크': { mp: 18, range: 350, dmg: 100, type: 'attack', icon: '🧊', cd: 1800, desc: '[단일 공격] 날카로운 얼음 기둥을 솟구치게 합니다.' },
    '포그 오브 슬리핑': { mp: 30, range: 400, aoe: 250, type: 'attack', dmg: 10, icon: '🌫️', cd: 4000, desc: '[디버프] 광역으로 적들의 이동과 공격을 멈춥니다.' }, 
    '블리자드': { mp: 15, range: 300, dmg: 150, aoe: 350, type: 'attack', icon: '❄️', cd: 3500, desc: '[광역 공격] 거대한 얼음 폭풍으로 화면 전체를 공격합니다.' }, 
    '미티어 스트라이크': { mp: 30, range: 400, dmg: 250, aoe: 400, type: 'attack', icon: '☄️', cd: 4500, desc: '[대형 광역] 거대한 운석을 소환하여 초토화시킵니다.' },
    '디스인티그레이트': { mp: 40, range: 400, dmg: 400, type: 'attack', projSpeed: 15, homing: true, icon: '💥', cd: 5000, desc: '[단일 극딜] 목표물을 완전히 분해하는 궁극의 창조 마법.' },
    '헤일 스톰': { mp: 40, range: 350, dmg: 180, aoe: 300, type: 'attack', icon: '🌨️', cd: 3500, desc: '[광역 공격] 강력한 우박 폭풍을 시전합니다.' },
    '이뮨 투 함': { mp: 30, type: 'buff', icon: '🛡️', cd: 3000, buffType: 'dmgReduct', val: 10, duration: 60000, desc: '[생존/보조] 1분간 받는 모든 데미지를 크게 감소시킵니다.' },
    '앱솔루트 배리어': { mp: 50, type: 'buff', icon: '✨', cd: 4000, buffType: 'invincible', val: 1, duration: 15000, desc: '[무적] 15초간 모든 공격과 마법으로부터 무적이 됩니다.' },
    '토네이도': { mp: 25, range: 350, dmg: 140, aoe: 250, type: 'attack', icon: '🌪️', cd: 3000, desc: '[광역 공격] 거대한 회오리를 소환해 적을 찢어버립니다.' },
    '데스 힐': { mp: 30, type: 'attack', range: 400, dmg: 100, icon: '💀', cd: 3000, desc: '[저주] 대상의 체력 회복 효과를 치명적인 대미지로 역전시킵니다.' },
    '마제스티': { mp: 40, type: 'buff', icon: '👑', cd: 3000, buffType: 'def', val: 15, duration: 120000, desc: '[보조] 2분간 방어력이 극대화(AC -15) 됩니다.' },
    '저지먼트': { mp: 60, range: 450, dmg: 600, aoe: 500, type: 'attack', icon: '⚔️', cd: 6000, desc: '[신화/광역] 거대한 심판의 검을 떨어뜨려 화면 내 모든 적을 섬멸합니다.' },
    '매스 텔레포트': { mp: 40, type: 'buff', icon: '🌀', cd: 5000, desc: '[유틸] 파티원 전체를 이끌고 지정된 장소로 텔레포트합니다.' },
    '네이쳐스 터치': { mp: 15, heal: 80, type: 'buff', icon: '🌿', cd: 1500, desc: '[회복/요정] 자연의 힘으로 체력을 크게 회복합니다.' },
    '어스 바인드': { mp: 30, range: 350, type: 'attack', dmg: 1, icon: '🪨', cd: 4000, desc: '[디버프/요정] 적을 돌로 만들어 무적 상태가 되지만 행동 불가로 만듭니다.' },
    '윈드 워크': { mp: 15, type: 'buff', icon: '💨', cd: 2000, buffType: 'speed', val: 60, duration: 300000, desc: '[보조/요정] 바람의 힘으로 이동/공속을 올립니다.' },
    '스톰 샷': { mp: 20, type: 'buff', icon: '🌪️', cd: 2000, buffType: 'atk', val: 5, duration: 300000, desc: '[보조/요정] 5분간 원거리 대미지가 크게 상승합니다.' },
    '트리플 애로우': { mp: 15, range: 400, dmg: 40, type: 'attack', icon: '🏹', cd: 1200, isTriple: true, desc: '[단일 공격/요정] 화살 3발을 동시에 발사합니다.' },
    '블러드 투 소울': { mp: 0, hpCost: 40, healMp: 15, type: 'buff', icon: '🩸', cd: 1000, desc: '[회복/요정] HP 40을 소모하여 MP 15를 회복합니다.' },
    '어스 스킨': { mp: 15, type: 'buff', icon: '🛡️', cd: 2000, buffType: 'def', val: 4, duration: 300000, desc: '[보조/요정] 5분간 방어력(AC) -4 효과를 얻습니다.' },
    '파이어 웨폰': { mp: 15, type: 'buff', icon: '🔥', cd: 2000, buffType: 'atk', val: 4, duration: 300000, desc: '[보조/요정] 5분간 근거리 타격치 +4 효과를 얻습니다.' },
    '워터 라이프': { mp: 20, type: 'buff', icon: '💧', cd: 2000, buffType: 'hpRegen', val: 10, duration: 300000, desc: '[회복/요정] 5분간 HP 회복률이 크게 상승합니다.' },
    '아쿠아 프로텍트': { mp: 30, type: 'buff', icon: '🌊', cd: 2000, buffType: 'dodge', val: 5, duration: 300000, desc: '[방어/요정] 원거리 회피율이 상승합니다.' },
    '스트라이커 게일': { mp: 30, range: 400, dmg: 10, type: 'attack', icon: '🎯', cd: 3000, desc: '[디버프/요정] 적의 원거리 방어력을 크게 낮춥니다.' },
    '소울 오브 프레임': { mp: 30, type: 'buff', icon: '🌋', cd: 3000, buffType: 'atk', val: 8, duration: 120000, desc: '[궁극/요정] 2분간 무기의 최대 대미지가 고정 적용됩니다.' },
    '폴루트 워터': { mp: 30, range: 400, dmg: 20, type: 'attack', icon: '☠️', cd: 3000, desc: '[디버프/요정] 대상의 치유 효과를 반감시킵니다.' },
    '쇼크 스턴': { mp: 15, range: 120, type: 'attack', dmg: 20, icon: '🛡️', cd: 5000, desc: '[기사 스킬] 적을 강하게 가격하여 행동을 제어합니다.' },
    '리덕션 아머': { mp: 30, type: 'buff', icon: '🛡️', cd: 3000, buffType: 'dmgReduct', val: 5, duration: 60000, desc: '[기사 스킬] 받는 피해를 고정 수치만큼 감소시킵니다.' },
    '카운터 바리어': { mp: 40, type: 'buff', icon: '⚔️', cd: 4000, buffType: 'counter', val: 1, duration: 30000, desc: '[기사 스킬] 근접 공격을 회피하고 강력하게 반격합니다.' },
    '바운스 어택': { mp: 20, type: 'buff', icon: '⚔️', cd: 3000, buffType: 'hitBonus', val: 6, duration: 120000, desc: '[기사 스킬] 2분간 근거리 명중률이 대폭 상승합니다.' },
    '솔리드 캐리지': { mp: 20, type: 'buff', icon: '🛡️', cd: 3000, buffType: 'dodge', val: 15, duration: 120000, desc: '[기사 스킬] 2분간 원거리 회피율(ER)이 상승합니다.' },
    '에어 블래스트': {
        name: '에어 블래스트',
        type: 'attack',
        dmg: 160,
    ...
    '블로우 어택': { mp: 30, type: 'buff', icon: '💥', cd: 3000, buffType: 'atk', val: 10, duration: 60000, desc: '[기사 스킬] 1분간 무기 타격치가 1.5배로 터질 확률이 생깁니다.' }
};
